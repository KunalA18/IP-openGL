...
int main()
{
    ...
    glUniform1f(glGetUniformLocation(framebufferProgram.ID, "gamma"), gam);
    ...
    // Texture
    Texture home("/home/kunal/Desktop/Gsoc/OpenGL/Resource Files/Textures/home.jpg", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGB, GL_UNSIGNED_BYTE);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glClearColor(pow(0.07f, gam), pow(0.13f, gam), pow(0.17f, gam), 1.0f);
